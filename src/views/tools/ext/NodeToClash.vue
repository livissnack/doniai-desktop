          ...
          <div class="buttons">
            <div class="dropdown" :class="active_dropdown ? 'is-active' : ''">
              <div class="dropdown-trigger">
                <button class="button node-type-btn" aria-haspopup="true" aria-controls="dropdown-menu3" @click="active_dropdown = true">
            ...
            <b-button class="ml-10" type="is-success" @click="startChange">
      ...
      <div class="columns">
        <div class="column">
          <div class="header">
            ...
            <div class="copy">
              <div>
                <b-button type="is-danger" size="is-small" @click="downloadFile('res_str')">下载</b-button>
                <b-button class="ml-10" type="is-primary" size="is-small" @click="copyStr('res_str')">复制</b-button>
              </div>
            </div>
          </div>
          <b-field>
  ...
  methods: {
    startChange() {
      ...
      if (this.currentMenu.id === 3) {
        this.res_str = this.parseClash(this.wait_str)
      }
    },
    async copyStr(type) {
      let copy_str = ''
...
# 创建者：livissnack.com
# 客户端：Clash.Meta
# 创建时间：2023-06-02 11:41:25
# 使用模版：LivisSnack 默认模版
# 节点数量：10
####################################
